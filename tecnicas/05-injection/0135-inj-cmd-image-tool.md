...
aliases: ["exiftool/ffmpeg/ImageMagick", "image-tool"]
---
...
**Variante:** **CVEs + injection.** Sem isso o playbook da família mente.
...
{"host":"127.0.0.1; id"}
# lab only — saída de id prova inj image-tool tag b39dbb
```

**Freio:** Evito `rm -rf` e forks bombs. Em Windows, cuidado com PowerShell encoding.

Falso amigo em exiftool/ffmpeg/ImageMagick: UI/log gritam, impacto não. Exijo EDR: child process de web server.
