...
# seguro: scan passivo
airodump-ng -c 6 --bssid AA:BB:CC:DD:EE:FF wlan0mon | tee wifi_6885b0.log
# destrutivo só em lab isolado: hostapd evil twin SSID LAB-6885b0
# NÃO pulverizar o prédio — wps
```
...
WPS PIN: se não reproduz efeito (authz/dado/exec), não infla severidade. Referência de sinal: WIPS rogue AP detection; 802.1X certificate validation training.
...
- [WPS PIN — evidência](0705-wifi-evil-twin-wps--evidencia.md)
