...
aliases: ["KARMA/known networks", "karma"]
---
...
# seguro: scan passivo
airodump-ng -c 6 --bssid AA:BB:CC:DD:EE:FF wlan0mon | tee wifi_24c543.log
# destrutivo só em lab isolado: hostapd evil twin SSID LAB-24c543
# NÃO pulverizar o prédio — karma
```
...
- [KARMA/known networks — evidência](0702-wifi-evil-twin-karma--evidencia.md)
