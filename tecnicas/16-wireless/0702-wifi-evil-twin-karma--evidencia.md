...
aliases: ["KARMA/known networks", "karma", "karma-evidencia"]
---

# KARMA/known networks — evidência

Pacote pra KARMA/known networks sobreviver peer review.
...
impacto: leitura cross-user (karma)
hash_prova: 5166d0
```
