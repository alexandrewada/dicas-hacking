...
aliases: ["backup enabled", "backup", "backup-evidencia"]
---

# backup enabled — evidência

Pacote pra backup enabled sobreviver peer review.
...
impacto: leitura cross-user (backup)
hash_prova: 10ef19
```
