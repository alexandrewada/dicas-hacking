...
aliases: ["file:// e wrappers", "file-proto", "file-proto-path"]
---

# file:// e wrappers — path

file:// e wrappers como pivô. Path curto > monte de finding isolado.
...
- Detalhe que pago pra ver: **Somente se stack permitir e ROE ok**.
- Mostro role/creds ou doc interno. Redirect trick só conta se mudar alcance real.

## Cadeia

1. Entrada (escopo)
2. Pivô: file:// e wrappers
3. Objetivo do ROE
...
{"target":"http://internal-admin.lab.local:9000/health"}
# SSRF file-proto: corpo/timing prova alcance interno — tag b2a818
```
...
- [file:// e wrappers](0047-web-ssrf-file-proto.md)
- [file:// e wrappers — detecção](0427-web-ssrf-file-proto--detecao.md)
...
- [leitura de arquivo local (path)](../07-ssrf-xxe/0171-xxe-classic-file-read.md)