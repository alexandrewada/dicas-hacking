...
aliases: ["abuso de signed URLs", "signed-url", "signed-url-path"]
---

# abuso de signed URLs — path

abuso de signed URLs como pivô. Path curto > monte de finding isolado.
