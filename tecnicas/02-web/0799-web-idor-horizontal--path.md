...
aliases: ["escalação horizontal", "horizontal", "horizontal-path"]
---

# escalação horizontal — path

escalação horizontal como pivô. Path curto > monte de finding isolado.
