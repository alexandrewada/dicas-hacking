...
aliases: ["SSRF via HTML-to-PDF", "pdf-render", "pdf-render-path"]
---

# SSRF via HTML-to-PDF — path

SSRF via HTML-to-PDF como pivô. Path curto > monte de finding isolado.
...
# SSRF pdf-render: corpo/timing prova alcance interno — tag e38ab3
```
...
- [SSRF via HTML-to-PDF — detecção](0428-web-ssrf-pdf-render--detecao.md)
