...
aliases: ["IDOR mesmo com UUID", "uuid", "uuid-path"]
---

# IDOR mesmo com UUID — path

IDOR mesmo com UUID como pivô. Path curto > monte de finding isolado.
...
- [IDOR mesmo com UUID](0032-web-idor-uuid.md)
