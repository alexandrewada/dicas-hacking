...
aliases: ["Zip Slip em extração", "zip-slip", "zip-slip-path"]
---

# Zip Slip em extração — path

Zip Slip em extração como pivô. Path curto > monte de finding isolado.
...
Host: app.lab.local
Content-Type: multipart/form-data; boundary=----20a487
