...
aliases: ["pipeline OCR/async", "async-ocr", "async-ocr-path"]
---

# pipeline OCR/async — path

pipeline OCR/async como pivô. Path curto > monte de finding isolado.
...
Host: app.lab.local
Content-Type: multipart/form-data; boundary=----e2abb4
