...
aliases: ["file:// e wrappers", "file-proto", "file-proto-detecao"]
---

# file:// e wrappers — detecção

Se o SOC não vê file:// e wrappers, o finding é de cobertura, não de ego ofensivo.
...
log: src=app dst=internal-admin.lab.local action=ALLOW? → gap (file-proto/5cc27e)
```
...
- [file:// e wrappers — path](0807-web-ssrf-file-proto--path.md)
