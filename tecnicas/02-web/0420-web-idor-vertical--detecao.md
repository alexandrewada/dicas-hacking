...
aliases: ["escalação vertical via object type", "vertical", "vertical-detecao"]
---

# escalação vertical via object type — detecção

Se o SOC não vê escalação vertical via object type, o finding é de cobertura, não de ego ofensivo.
...
regra: deny quando subject != owner — tag f6093b (vertical)
```
