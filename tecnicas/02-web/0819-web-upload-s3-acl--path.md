...
aliases: ["ACL pública pós-upload", "s3-acl", "s3-acl-path"]
---

# ACL pública pós-upload — path

ACL pública pós-upload como pivô. Path curto > monte de finding isolado.
...
Host: app.lab.local
Content-Type: multipart/form-data; boundary=----c4a2c0
...
- [ACL pública pós-upload](0059-web-upload-s3-acl.md)
