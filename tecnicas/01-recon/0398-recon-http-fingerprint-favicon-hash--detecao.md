# favicon hash (Shodan-style) — detecção

Purple em favicon hash (Shodan-style): uma execução limpa. A pergunta é se alertou — não se o exploit 'passa'.
...
DNS NXDOMAIN spike for enum pattern — favicon-hash 398e71
```
