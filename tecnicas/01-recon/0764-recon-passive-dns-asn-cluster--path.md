...
aliases: ["clustering por ASN e netblocks", "asn-cluster", "asn-cluster-path"]
---

# clustering por ASN e netblocks — path

clustering por ASN e netblocks como pivô. Path curto > monte de finding isolado.
...
1. Entrada (escopo)
2. Pivô: clustering por ASN e netblocks
3. Objetivo do ROE
...
# marcar dev-/staging- ; tag 63cd50 (asn-cluster)
```
