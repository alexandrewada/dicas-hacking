...
aliases: ["heurística via Cache-Control/ETag", "cache-headers", "cache-headers-path"]
---

# heurística via Cache-Control/ETag — path

heurística via Cache-Control/ETag como pivô. Path curto > monte de finding isolado.
...
1. Entrada (escopo)
2. Pivô: heurística via Cache-Control/ETag
3. Objetivo do ROE
...
# marcar dev-/staging- ; tag 01535c (cache-headers)
```
