...
aliases: ["robots.txt e sitemap.xml", "robots-sitemap", "robots-sitemap-detecao"]
---

# robots.txt e sitemap.xml — detecção

Se o SOC não vê robots.txt e sitemap.xml, o finding é de cobertura, não de ego ofensivo.
...
DNS NXDOMAIN spike for enum pattern — robots-sitemap 767e15
```
...
- [robots.txt e sitemap.xml](0015-recon-http-fingerprint-robots-sitemap.md)
