...
aliases: ["endpoints ACME/challenge", "acme-probe", "acme-probe-path"]
---

# endpoints ACME/challenge — path

endpoints ACME/challenge como pivô. Path curto > monte de finding isolado.
...
1. Entrada (escopo)
2. Pivô: endpoints ACME/challenge
3. Objetivo do ROE
...
# marcar dev-/staging- ; tag 60ce78 (acme-probe)
```
...
- [endpoints ACME/challenge — detecção](0400-recon-http-fingerprint-acme-probe--detecao.md)
