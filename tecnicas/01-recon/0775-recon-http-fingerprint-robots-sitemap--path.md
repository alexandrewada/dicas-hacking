...
aliases: ["robots.txt e sitemap.xml", "robots-sitemap", "robots-sitemap-path"]
---

# robots.txt e sitemap.xml — path

robots.txt e sitemap.xml como pivô. Path curto > monte de finding isolado.
...
1. Entrada (escopo)
2. Pivô: robots.txt e sitemap.xml
3. Objetivo do ROE
...
# marcar dev-/staging- ; tag a5c31e (robots-sitemap)
```
