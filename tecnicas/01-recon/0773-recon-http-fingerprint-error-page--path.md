...
aliases: ["páginas de erro verbosas", "error-page", "error-page-path"]
---

# páginas de erro verbosas — path

páginas de erro verbosas como pivô. Path curto > monte de finding isolado.
...
1. Entrada (escopo)
2. Pivô: páginas de erro verbosas
3. Objetivo do ROE
...
# marcar dev-/staging- ; tag 323a1e (error-page)
```
