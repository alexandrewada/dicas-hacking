...
aliases: ["teste autorizado de AXFR", "zone-transfer", "zone-transfer-path"]
---

# teste autorizado de AXFR — path

teste autorizado de AXFR como pivô. Path curto > monte de finding isolado.
...
1. Entrada (escopo)
2. Pivô: teste autorizado de AXFR
3. Objetivo do ROE
...
# marcar dev-/staging- ; tag ac8b31 (zone-transfer)
```
