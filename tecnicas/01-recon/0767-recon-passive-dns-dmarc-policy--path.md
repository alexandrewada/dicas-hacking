...
aliases: ["auditoria DMARC/BIMI", "dmarc-policy", "dmarc-policy-path"]
---

# auditoria DMARC/BIMI — path

auditoria DMARC/BIMI como pivô. Path curto > monte de finding isolado.
...
# marcar dev-/staging- ; tag f9a414 (dmarc-policy)
```
