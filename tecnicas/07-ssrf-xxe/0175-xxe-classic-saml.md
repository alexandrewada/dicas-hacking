...
<r>&xxe;</r>
<!-- XXE saml lab read mínimo — tag d50da7 -->
```
...
Antes de Critical em SAML XXE, confiro se a telemetria que eu cobraria reagiria — Parser errors; egress to unexpected DTD hosts.
