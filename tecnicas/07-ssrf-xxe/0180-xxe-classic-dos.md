...
<r>&xxe;</r>
<!-- XXE dos lab read mínimo — tag ba30c4 -->
```
...
Parser errors; egress to unexpected DTD hosts.

→ Desabilitar external entities; usar JSON; patch parsers; network egress deny.
