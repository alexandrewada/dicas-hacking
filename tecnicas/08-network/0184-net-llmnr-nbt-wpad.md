...
# trigger wpad; evidência: auth USER_A + ação não destrutiva tag 9fe0b4
```
...
WPAD spoofing: se não reproduz efeito (authz/dado/exec), não infla severidade. Referência de sinal: Detectar Rogue WPAD/LLMNR responders; SMB signing compliance.
