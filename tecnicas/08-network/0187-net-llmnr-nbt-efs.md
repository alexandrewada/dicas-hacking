...
# trigger efs; evidência: auth USER_A + ação não destrutiva tag db28fe
```
...
Já abri High demais em coerção EFS por sintoma sem efeito. Cruzei com: Detectar Rogue WPAD/LLMNR responders; SMB signing compliance. Sem side-effect, baixo.
...
- [coerção EFS — hardening](0947-net-llmnr-nbt-efs--hardening.md)
