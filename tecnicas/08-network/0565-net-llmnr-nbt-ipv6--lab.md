...
aliases: ["MITM IPv6 (mitm6)", "ipv6", "ipv6-lab"]
---

# MITM IPv6 (mitm6) — lab

Lab só pra MITM IPv6 (mitm6). Se não reproduz isolado, não confio no finding de prod.
...
# trigger ipv6; evidência: auth USER_A + ação não destrutiva tag f4a51f
```
...
- [MITM IPv6 (mitm6) — hardening](0945-net-llmnr-nbt-ipv6--hardening.md)
