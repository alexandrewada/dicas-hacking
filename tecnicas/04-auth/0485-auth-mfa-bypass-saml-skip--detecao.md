...
aliases: ["skip MFA em SAML secondary", "saml-skip", "saml-skip-detecao"]
---

# skip MFA em SAML secondary — detecção

Gap de detecção em `T1621 Multi-Factor Authentication Request Generation` / skip MFA em SAML secondary. PoC mínimo, telemetria ligada.
...
app=APP_LAB flow=saml-skip tag=a749b2
```
