...
aliases: ["bypass de lockout por pool de IPs", "lockout-bypass", "lockout-bypass-detecao"]
---

# bypass de lockout por pool de IPs — detecção

Gap de detecção em `T1110.003 Password Spraying` / bypass de lockout por pool de IPs. PoC mínimo, telemetria ligada.
...
app=APP_LAB flow=lockout-bypass tag=d53488
```
