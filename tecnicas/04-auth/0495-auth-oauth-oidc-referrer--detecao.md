...
aliases: ["leak via Referer", "referrer", "referrer-detecao"]
---

# leak via Referer — detecção

Purple em leak via Referer: uma execução limpa. A pergunta é se alertou — não se o exploit 'passa'.
...
app=APP_LAB flow=referrer tag=ee7979
```
