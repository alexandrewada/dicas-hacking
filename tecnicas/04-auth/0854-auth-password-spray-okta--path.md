...
aliases: ["Okta/Auth0", "okta", "okta-path"]
---

# Okta/Auth0 — path

Okta/Auth0 como pivô. Path curto > monte de finding isolado.
...
```http
GET /oauth/authorize?client_id=APP_LAB&redirect_uri=https://evil.lab.local/cb&response_type=code&state=fe34d4 HTTP/1.1
Host: idp.lab.local
