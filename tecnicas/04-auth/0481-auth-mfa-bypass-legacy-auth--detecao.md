...
aliases: ["protocolos legados sem MFA", "legacy-auth", "legacy-auth-detecao"]
---

# protocolos legados sem MFA — detecção

Gap de detecção em `T1621 Multi-Factor Authentication Request Generation` / protocolos legados sem MFA. PoC mínimo, telemetria ligada.
...
app=APP_LAB flow=legacy-auth tag=44b8ef
```
