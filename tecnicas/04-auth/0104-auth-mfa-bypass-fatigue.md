...
aliases: ["MFA fatigue (push bombing)", "fatigue"]
---
...
```http
GET /oauth/authorize?client_id=APP_LAB&redirect_uri=https://evil.lab.local/cb&response_type=code&state=0fff60 HTTP/1.1
Host: idp.lab.local
