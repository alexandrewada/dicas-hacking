...
aliases: ["backup codes em massa", "backup-codes", "backup-codes-detecao"]
---

# backup codes em massa — detecção

Gap de detecção em `T1621 Multi-Factor Authentication Request Generation` / backup codes em massa. PoC mínimo, telemetria ligada.
...
app=APP_LAB flow=backup-codes tag=c1b7f6
```
