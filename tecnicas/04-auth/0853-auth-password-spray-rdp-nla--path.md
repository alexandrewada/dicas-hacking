...
aliases: ["RDP/NLA", "rdp-nla", "rdp-nla-path"]
---

# RDP/NLA — path

RDP/NLA como pivô. Path curto > monte de finding isolado.
...
```http
GET /oauth/authorize?client_id=APP_LAB&redirect_uri=https://evil.lab.local/cb&response_type=code&state=be382c HTTP/1.1
Host: idp.lab.local
