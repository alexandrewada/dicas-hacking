...
aliases: ["RDP saved creds / cmdkey", "rdp"]
---

# RDP saved creds / cmdkey
...
sc.exe qc SVC_rdp
# writable + priv service = privesc path tag 7482ca
```
...
Antes de Critical em RDP saved creds / cmdkey, confiro se a telemetria que eu cobraria reagiria — EDR LSASS access; Sysmon 10; Credential Guard.
...
- [RDP saved creds / cmdkey — lab](0628-win-cred-rdp--lab.md)
