...
aliases: ["Credential Manager", "vault", "vault-lab"]
---

# Credential Manager — lab
...
sc.exe qc SVC_vault
# writable + priv service = privesc path tag 82e502
```
...
- [Credential Manager](0243-win-cred-vault.md)
