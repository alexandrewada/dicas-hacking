...
aliases: ["ListBucket público", "public-list"]
---
...
aws sts get-caller-identity --profile lab_3bfbed
aws s3api get-bucket-policy --bucket lab-bucket-public-list --profile lab_3bfbed
# seguro: Get*/List*; destrutivo (DeleteBucket) só em lab throwaway
# effective perms public-list
```
...
- [ListBucket público — evidência](0651-aws-s3-public-list--evidencia.md)
