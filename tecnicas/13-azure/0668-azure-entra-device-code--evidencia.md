...
aliases: ["device code phishing", "device-code", "device-code-evidencia"]
---

# device code phishing — evidência

Pacote pra device code phishing sobreviver peer review.
...
impacto: leitura cross-user (device-code)
hash_prova: c8d25e
```
...
- [device code phishing](0288-azure-entra-device-code.md)
