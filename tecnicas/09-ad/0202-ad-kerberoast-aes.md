...
aliases: ["AES ainda fraco se password ruim", "aes"]
---

# AES ainda fraco se password ruim
...
**Variante:** **Não assume AES=safe** — muda ruído e o que entra no PDF. AES não salva password fraca — TGS AES cracka offline igual, só mais lento. Controle de verdade: gMSA / complexidade. Priorizo serviço com SPN + password fraca. Dump de todo o domínio é amador e barulhento.
...
GetUserSPNs.py lab.local/USER_A:PASS_LAB -dc-ip DC01.lab.local -request \
  -outputfile roast_aes_dfbbd5.kirbi
...
Antes de Critical em AES ainda fraco se password ruim, confiro se a telemetria que eu cobraria reagiria — Event 4769 anômalos; honeypot SPNs; AES-only policies.
...
- [AES ainda fraco se password ruim — lab](0582-ad-kerberoast-aes--lab.md)
