...
certipy req -u USER_A@lab.local -p PASS_LAB -ca LAB-CA -template TPL_esc2 -out esc2_4aa757
```

## OpSec

Certificados são persistência — revogo sempre ao final. Path até tier0 com ACE/edge exato (GenericAll, WriteDacl, ForceChangePassword). 'Deu certo' sem grafo não fecha.
