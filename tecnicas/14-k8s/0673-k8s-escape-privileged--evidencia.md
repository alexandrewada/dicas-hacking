...
aliases: ["Pod privileged", "privileged", "privileged-evidencia"]
---

# Pod privileged — evidência

Pacote pra Pod privileged sobreviver peer review.
...
impacto: leitura cross-user (privileged)
hash_prova: c9f3c2
```
