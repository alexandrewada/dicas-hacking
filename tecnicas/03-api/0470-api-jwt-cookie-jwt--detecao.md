...
aliases: ["JWT em cookie sem flags", "cookie-jwt", "cookie-jwt-detecao"]
---

# JWT em cookie sem flags — detecção

Gap de detecção em `T1550 Use Alternate Authentication Material` / JWT em cookie sem flags. PoC mínimo, telemetria ligada.
...
```text
authz_fail OR jwt_verify_error claim=cookie-jwt
alerta se alg in (none, HS256) com key pública — tag c29565
```
