...
aliases: ["manipulação de preço/quantidade", "price"]
---
...
# mass-assign price: GET depois e comparar role — tag 618bcc
```
...
| Evidência | Request com campo privilegiado; response provando alteração. |
...
- [manipulação de preço/quantidade — detecção](0442-api-mass-assignment-price--detecao.md)
