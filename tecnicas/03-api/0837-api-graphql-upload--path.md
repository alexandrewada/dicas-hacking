# graphql-multipart-request — path

graphql-multipart-request como pivô. Path curto > monte de finding isolado.
...
1. Entrada (escopo)
2. Pivô: graphql-multipart-request
3. Objetivo do ROE
