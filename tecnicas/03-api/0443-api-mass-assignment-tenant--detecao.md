...
aliases: ["troca de organization_id", "tenant", "tenant-detecao"]
---

# troca de organization_id — detecção

Gap de detecção em `T1190 Exploit Public-Facing Application` / troca de organization_id. PoC mínimo, telemetria ligada.
...
expected deny — tag 0c6e24 (tenant)
```
...
- [troca de organization_id — path](0823-api-mass-assignment-tenant--path.md)
