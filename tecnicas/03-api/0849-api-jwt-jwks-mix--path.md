...
aliases: ["JWKS key confusion multi-tenant", "jwks-mix", "jwks-mix-path"]
---

# JWKS key confusion multi-tenant — path

JWKS key confusion multi-tenant como pivô. Path curto > monte de finding isolado.
...
1. Entrada (escopo)
2. Pivô: JWKS key confusion multi-tenant
3. Objetivo do ROE
...
Host: api.lab.local
Authorization: Bearer JWT_jwks-mix_dc63f8
